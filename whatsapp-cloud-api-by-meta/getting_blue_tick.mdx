...
## **Step-by-Step Guide: Applying for WhatsApp Green Tick**
 ...
 1. Open your web browser and navigate to the Meta Business Suite. The steps for construction of the same can be found in [Setting Up Your Facebook Business Manager](https://help. ChatBlend.com/platform-guidelines-and-training/whatsapp-cloud-api-by-meta/setting-up-your-facebook-business-manager).
