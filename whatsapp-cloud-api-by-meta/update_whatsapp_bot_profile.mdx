...
3. Open WhatsApp Manager.
   ...
   ![218 Update Whatsapp Bot Profile  ChatBlend Resource C 1 Pn](/images/platform-guidelines-training/update-whatsapp-bot-profile/218.update_whatsapp_bot_profile__ChatBlend_resource_c-1.png)
...
![218 Update Whatsapp Bot Profile  ChatBlend Resource C 2 Pn](/images/platform-guidelines-training/update-whatsapp-bot-profile/218.update_whatsapp_bot_profile__ChatBlend_resource_c-2.png)
...
![218 Update Whatsapp Bot Profile  ChatBlend Resource C 3 Pn](/images/platform-guidelines-training/update-whatsapp-bot-profile/218.update_whatsapp_bot_profile__ChatBlend_resource_c-3.png)

Congratulations\! You have successfully updated your WhatsApp Bot profile. You can alternatively do the same from the ChatBlend dashboard as well.
