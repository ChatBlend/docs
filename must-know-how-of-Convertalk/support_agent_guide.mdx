...
![238 Support Agent Guide  ChatBlend Resource Centre 1 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-1.png)
...
![238 Support Agent Guide  ChatBlend Resource Centre 2 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-2.png)
...
![238 Support Agent Guide  ChatBlend Resource Centre 3 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-3.png)
...
- **Status** - The Status of each chat is a key feature for both individual agents and teams to track the current state of each conversation. It helps to ensure that no chat is left unattended or missed.
  ...
  ![238 Support Agent Guide  ChatBlend Resource Centre 4 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-4.png)
...
![238 Support Agent Guide  ChatBlend Resource Centre 5 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-5.png)

- **Assigned** **to** (**Agent**) - The name of the agent to whom the chat is assigned.

  ![238 Support Agent Guide  ChatBlend Resource Centre 6 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-6.png)
...
![238 Support Agent Guide  ChatBlend Resource Centre 7 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-7.png)
...
![238 Support Agent Guide  ChatBlend Resource Centre 8 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-8.png)
...
- You can assign tags to categorize or prioritize chats.
  ...
  ![238 Support Agent Guide  ChatBlend Resource Centre 9 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-9.png)
- You can change the status of the conversation (e.g., "Open," "In Progress," or "Resolved").

  ![238 Support Agent Guide  ChatBlend Resource Centre 10 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-10.png)
- You can assign the chat to another agent if needed.

  ![238 Support Agent Guide  ChatBlend Resource Centre 11 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-11.png)
- You can also download the chat transcript from the button given on the top bar.

  ![238 Support Agent Guide  ChatBlend Resource Centre 11 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-12.png)
- **Transfer to bot -** You can transfer the chat again to the bot once the live chat is over.

  ![238 Support Agent Guide  ChatBlend Resource Centre 13 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-13.png)
...
![238 Support Agent Guide  ChatBlend Resource Centre 13 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-14.png)
...
![238 Support Agent Guide  ChatBlend Resource Centre 15 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-15.png)
...
![238 Support Agent Guide  ChatBlend Resource Centre 16 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-16.png)

- **Translation:** You can translate the chat to your preferred language using the translate button

  ![238 Support Agent Guide  ChatBlend Resource Centre 17 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-17.png)
- **Quick Reply:** Use the quick reply feature for repetitive messages like greetings or common responses. Simply click on "Add New" to create a quick reply, which you can use whenever needed.
  ...
  ![238 Support Agent Guide  ChatBlend Resource Centre 18 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-18.png)
...
- **Visitor Profile:** View detailed information about the user you are interacting with, including location, phone number, and any custom attributes added.
  ...
  ![238 Support Agent Guide  ChatBlend Resource Centre 20 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-20.png)
- You can also edit these information by clicking on the edit icon and then save them by clicking on the save icon given.

  ![238 Support Agent Guide  ChatBlend Resource Centre 21 Pn](/images/platform-guidelines-training/support-agent-guide/238.support_agent_guide__ChatBlend_resource_centre-21.png)
