...
- Displays columns for **Visitor Name**, **Phone Number**, and **Email** for easy identification.
  ...
  ![173 Contacts  ChatBlend Resource Centre 1 Pn](/images/how-botpenguin-works/contact/173.contacts__ChatBlend_resource_centre-1.png)
...
- To create a new tag, click on the **"Create Tag"** button available in the dropdown menu.
  ...
  ![173 Contacts  ChatBlend Resource Centre 2 Pn](/images/how-botpenguin-works/contact/173.contacts__ChatBlend_resource_centre-2.png)
...
- If you need to add a new agent, use the **"Create Agent"** button in the dropdown menu.
  ...
  ![173 Contacts  ChatBlend Resource Centre 3 Pn](/images/how-botpenguin-works/contact/173.contacts__ChatBlend_resource_centre-3.png)
...
- Create new status via the **"Create Status"** button in the dropdown menu.
  ...
  ![173 Contacts  ChatBlend Resource Centre 5 Pn](/images/how-botpenguin-works/contact/173.contacts__ChatBlend_resource_centre-4.png)

5. **Actions**:

- The action column contains buttons to **Call**, **Delete**, or **Copy** a user’s chat for further reference.

  ![173 Contacts  ChatBlend Resource Centre 5 Pn](/images/how-botpenguin-works/contact/173.contacts__ChatBlend_resource_centre-5.png)
...
1. **Chat Translation**:
   - Instantly translate the chat into your preferred language with the **Translate** button.
     ...
     ![173 Contacts  ChatBlend Resource Centre 6 Pn](/images/how-botpenguin-works/contact/173.contacts__ChatBlend_resource_centre-6.png)
2. **Transfer Chat**:

- Transfer the current chat to another agent using the **Transfer** button.

  ![173 Contacts  ChatBlend Resource Centre 7 Pn](/images/how-botpenguin-works/contact/173.contacts__ChatBlend_resource_centre-7.png)

3. **Download Chat Transcript**:

- Download the entire chat history by clicking on the **Download Transcript** button.

  ![173 Contacts  ChatBlend Resource Centre 7 Pn](/images/how-botpenguin-works/contact/173.contacts__ChatBlend_resource_centre-8.png)
...
- Assign tags and status to the chat directly from this window. You can also create new tags or status using the provided options in the dropdown menus.
  ...
  ![173 Contacts  ChatBlend Resource Centre 9 Pn](/images/how-botpenguin-works/contact/173.contacts__ChatBlend_resource_centre-9.png)
...
- The **Visitor Profile** section provides key details about the user interacting with the bot, including:
  ...
  ![173 Contacts  ChatBlend Resource Centre 10 Pn](/images/how-botpenguin-works/contact/173.contacts__ChatBlend_resource_centre-10.png)
...
- **How to Apply Filters**: Simply select the desired filter from the dropdown menu in the inbox panel, and the relevant chats will be displayed accordingly.
  ...
  ![173 Contacts  ChatBlend Resource Centre 11 Pn](/images/how-botpenguin-works/contact/173.contacts__ChatBlend_resource_centre-11.png)
