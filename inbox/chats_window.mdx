...
![171 Chats Window  ChatBlend Resource Centre 1 Pn](/images/how-botpenguin-works/chat-window/171.chats_window__ChatBlend_resource_centre-1.png)
...
- To create a new tag, click on the **"Create Tag"** button available in the dropdown menu.
  ...
  ![171 Chats Window  ChatBlend Resource Centre 2 Pn](/images/how-botpenguin-works/chat-window/171.chats_window__ChatBlend_resource_centre-2.png)
...
2. **Assign Live Agent**:
   ...
   - If you need to add a new agent, use the **"Create Agent"** button in the dropdown menu.
     ...
     ![171 Chats Window  ChatBlend Resource Centre 3 Pn](/images/how-botpenguin-works/chat-window/171.chats_window__ChatBlend_resource_centre-3.png)
3. **Chat Status**:
   - Assign a status to each chat.
   - Create new status via the **"Create Status"** button in the dropdown menu.

     ![171 Chats Window  ChatBlend Resource Centre 4 Pn](/images/how-botpenguin-works/chat-window/171.chats_window__ChatBlend_resource_centre-4.png)
4. **Actions**:
   - The action column contains buttons to **Call**, **Delete**, or **Copy** a user’s chat for further reference.

     ![171 Chats Window  ChatBlend Resource Centre 6 Pn](/images/how-botpenguin-works/chat-window/171.chats_window__ChatBlend_resource_centre-5.png)
...
4. **Tag and Status Assignment**:
   - Assign tags and status to the chat directly from this window. You can also create new tags or status using the provided options in the dropdown menus.
     ...
     ![171 Chats Window  ChatBlend Resource Centre 6 Pn](/images/how-botpenguin-works/chat-window/171.chats_window__ChatBlend_resource_centre-6.png)
5. **FAQ's:**
   - Directly train for FAQ's using the icon given on the tab.

     ![171 Chats Window  ChatBlend Resource Centre 7 Pn](/images/how-botpenguin-works/chat-window/171.chats_window__ChatBlend_resource_centre-7.png)
6. **Quick Replies**
...
- The **Visitor Profile** section provides key details about the user interacting with the bot, including:
  ...
  - Any **custom attributes** you've created, like preferences or additional details.
    ...
    ![171 Chats Window  ChatBlend Resource Centre 8 Pn](/images/how-botpenguin-works/chat-window/171.chats_window__ChatBlend_resource_centre-8.png)
...
- **How to Apply Filters**: Simply select the desired filter from the dropdown menu in the inbox panel, and the relevant chats will be displayed accordingly.
  ...
  ![171 Chats Window  ChatBlend Resource Centre 9 Pn](/images/how-botpenguin-works/chat-window/171.chats_window__ChatBlend_resource_centre-9.png)
