...
1. Sign into you  ChatBlend account and select the WhatsApp chatbot.
...
2. Click on "WhatsApp Bot Setting", and go over to the "Triggers" tab.
   ...
   ![61 Triggers  ChatBlend Resource Centre 2 Pn](/images/how-botpenguin-works/whatsapp-trigger/61.triggers__ChatBlend_resource_centre-2.png)
...
- **Subscribe/Unsubscribe Triggers**: Configure terms (e.g., “start”, “stop”) to automate user opt-ins and opt-outs from marketing flows or broadcasts.
  ...
  ![61 Triggers  ChatBlend Resource Centre 3 Pn](/images/how-botpenguin-works/whatsapp-trigger/61.triggers__ChatBlend_resource_centre-3.png)
...
- **Contains Match**: The chatflow is triggered if the keyword appears anywhere in the user’s message (e.g., “Can you share pricing details?” triggers the “pricing” flow).
  ...
  ![61 Triggers  ChatBlend Resource Centre 4 Pn](/images/how-botpenguin-works/whatsapp-trigger/61.triggers__ChatBlend_resource_centre-4.png)

### **Section D: Using Chatbot Ice Breaker:**

Ice Breakers are ready-made message options that show up when someone opens your WhatsApp chatbot for the first time. When a user taps on one, it can start a specific chatbot flow in  ChatBlend.

- Enter the prompt of the Ice Breaker.
- Select the chatflow to be started when the above Ice Breaker is chosen.

  ![61 Triggers  ChatBlend Resource Centre 5 Pn](/images/how-botpenguin-works/whatsapp-trigger/61.triggers__ChatBlend_resource_centre-5.png)
...
- **Select the Trigger Action:** Choose what action the command should perform—restart chat, start live chat, subscribe/unsubscribe, or run a chatflow.
  ...
  ![61 Triggers  ChatBlend Resource Centre 6 Pn](/images/how-botpenguin-works/whatsapp-trigger/61.triggers__ChatBlend_resource_centre-6.png)
