...
public class ReplaceChatBlendFixes {
    public static void main(String[] args) {
        ...
        try (Stream<Path> pathStream = Files.walk(folderPath)) {
            List<Path> allTextFiles = pathStream
                    ...
                    .filter(ReplaceChatBlendFixes::isTextFile)
    ...
    private static boolean processFile(Path filePath) {
        try {
            ...
            String updated = content
                    .replace("_ ChatBlend", "_ChatBlend")
                    .replace("how- ChatBlend-works", "how-botpenguin-works");
