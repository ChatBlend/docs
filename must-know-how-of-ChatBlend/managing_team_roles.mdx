...
<Info>
  Please note: Only the King (Paid) plan have the feature of having more than one team member (i.e. three), if you need more than that, Please request the  ChatBlend support team for the same.
</Info>
...
In  ChatBlend, you can efficiently manage team roles and users to streamline access and permissions within your account. Here's a step-by-step guide on how to do it:

#### **Step 1: Access the  ChatBlend Dashboard**
...
- Set up the role by providing the following details:
  ...
  - **Assign Permissions**: Customize permissions for this role based on your specific needs. Permissions are related to different modules within the  ChatBlend platform.
...
- Click "Create User" to add the new team member to your  ChatBlend account.
...
And there you have it\! You've successfully created a new role and added a new user to your  ChatBlend account. This streamlined management process helps you control access and permissions effectively.