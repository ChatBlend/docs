...
A Widget is a chat interface that can be installed in your website, ads, blogs or any promotional content to route subscribers to your Chatbot. You can create multiple widgets by following a few easy steps on the  ChatBlend dashboard.

### **How to Manage a Widget**

1. Login to you  ChatBlend Account.
...
4. Then click on Widgets section.
   ...
   ![37 Widget ChatBlend Resource Centre 1 Pn](/images/how-botpenguin-works/widget/37.widget__ChatBlend_resource_centre-1.png)
...
- You can edit the pre-populated message which will be sent along with the widget link.
  ...
  ![37 Widget ChatBlend Resource Centre 2 Pn](/images/how-botpenguin-works/widget/37.widget__ChatBlend_resource_centre-2.png)
...
- Once the link is clicked customer will be redirected to chat with your bot.
  ...
  ![37 Widget ChatBlend Resource Centre 3 Pn](/images/how-botpenguin-works/widget/37.widget__ChatBlend_resource_centre-3.png)
...
- Click on "Update Widget" to save the changes.
  ...
  ![37 Widget ChatBlend Resource Centre 4 Pn](/images/how-botpenguin-works/widget/37.widget__ChatBlend_resource_centre-4.png)

![37 Widget ChatBlend Resource Centre 5 Pn](/images/how-botpenguin-works/widget/37.widget__ChatBlend_resource_centre-5.png)
...
- You can click on "Download QR Code" and QR Code will be downloaded which can be shared and scanned by customers and they will be redirected to chat with your chatbot.
  ...
  ![37 Widget ChatBlend Resource Centre 6 Pn](/images/how-botpenguin-works/widget/37.widget__ChatBlend_resource_centre-6.png)
- You can edit the Pre-populated message which will appear after scanning the QR code by clicking on the "Edit pre-populated message" button.
  ...
  ![37 Widget ChatBlend Resource Centre 7 Pn](/images/how-botpenguin-works/widget/37.widget__ChatBlend_resource_centre-7.png)
