...
1. Log into your  ChatBlend Account and go to the Instagram bot. Click on the bot.
2. Go to "**Instagram Automation"**.
3. Click on the Automation setting and go to the "**Auto-Reply**" tab. Click on "**Create Reply**"

   ![44 Instagram Auto Replies  ChatBlend Resource Centre 1 Pn](/images/how-botpenguin-works/instagram-autoreply-feature/44.instagram_auto-replies__ChatBlend_resource_centre-1.png)
...
6. Configure Comment Message:
   ...
   ![44 Instagram Auto Replies  ChatBlend Resource Centre 3 Pn](/images/how-botpenguin-works/instagram-autoreply-feature/44.instagram_auto-replies__ChatBlend_resource_centre-3.png)
7. Once done, click on "**Create Reply**" to save the reply.

   ![44 Instagram Auto Replies  ChatBlend Resource Centre 4 Pn](/images/how-botpenguin-works/instagram-autoreply-feature/44.instagram_auto-replies__ChatBlend_resource_centre-4.png)
...
There, you're all set to use Instagram Auto-reply feature. Choose the post of your choice and let  ChatBlend Automate the work\!