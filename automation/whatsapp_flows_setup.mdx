---
description: "This page contains the detailed description of the forms setup in  ChatBlend. "
...
3. Select WA Flow (Forms).
   ...
   ![40 Whatsapp Flows Forms Setup  ChatBlend Resource Ce 1 Pn](/images/how-botpenguin-works/whatsapp-flows-setup/40.whatsapp_flows_forms_setup__ChatBlend_resource_ce-5.png)
...
7. Click on "Get Started" to create your WhatsApp flow.
   ...
   ![40 Whatsapp Flows Forms Setup  ChatBlend Resource Ce 6 Pn](/images/how-botpenguin-works/whatsapp-flows-setup/40.whatsapp_flows_forms_setup__ChatBlend_resource_ce-6.png)
8. Fill the given details, including your flow Name, Category, Template, etc. You can set the flow to have an endpoint, or a place where it sends its data other than WA.
   ...
   ![40 Whatsapp Flows Forms Setup  ChatBlend Resource Ce 3 Pn](/images/how-botpenguin-works/whatsapp-flows-setup/40.whatsapp_flows_forms_setup__ChatBlend_resource_ce-3.png)
...
9. After clicking on the "**Create**" button, the flow will be created. It can be edited by replacing the JSON code with the code of your own flow.
   ...
   11. You can click on Add Another Field for adding more flow responses.
       ...
       ![40 Whatsapp Flows Forms Setup  ChatBlend Resource Ce 4 Pn](/images/how-botpenguin-works/whatsapp-flows-setup/40.whatsapp_flows_forms_setup__ChatBlend_resource_ce-4.png)
