...
2. When you select a template you will be asked to add header media which you can import from your system.
   ...
   ![41 Whatsapp Broadcast Setup  ChatBlend Resource Cent 1 Pn](/images/how-botpenguin-works/whatsapp-broadcast-setup/41.whatsapp_broadcast_setup_\_ChatBlend_resource_cent-1.png)
...
1. Once you select the template, when "Using Group" is selected in whom to send you will get a new drop down to select or create a group. And if you select "Using CSV" then upload a csv file for the same.
   ...
   ![41 Whatsapp Broadcast Setup  ChatBlend Resource Cent 2 Pn](/images/how-botpenguin-works/whatsapp-broadcast-setup/41.whatsapp_broadcast_setup_\_ChatBlend_resource_cent-2.png)
2. Also, select the scheduled date to send the Broadcast, if not to be sent immediately.

   ![41 Whatsapp Broadcast Setup  ChatBlend Resource Cent 3 Pn](/images/how-botpenguin-works/whatsapp-broadcast-setup/41.whatsapp_broadcast_setup_\_ChatBlend_resource_cent-3.png)
