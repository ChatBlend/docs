...
![20 Whatsapp Payment ChatBlend Botpenguin Resource C 1 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_component_ChatBlend__botpenguin_resource_c-1.png)
- Select the flow in which you want to include the Payment component into.

![20 Whatsapp Payment ChatBlend Botpenguin Resource C 2 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_component_ChatBlend__botpenguin_resource_c-2.png)
- Go to the "Trigger Actions", and then click on "Payments" to add the payments components.

![20 Whatsapp Payment Components  ChatBlend Resource C 3 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_components__ChatBlend_resource_c-3.png)

\
Fill out the following details to setup you payment methodology and needs:

![20 Whatsapp Payment Components  ChatBlend Resource C 4 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_components__ChatBlend_resource_c-4.png)
...
![20 Whatsapp Payment Components  ChatBlend Resource C 5 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_components__ChatBlend_resource_c-5.png)
...
![20 Whatsapp Payment Components  ChatBlend Resource C 6 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_components__ChatBlend_resource_c-6.png)
...
![20 Whatsapp Payment Components  ChatBlend Resource C 6 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_components__ChatBlend_resource_c-7.png)
...
![20 Whatsapp Payment Components  ChatBlend Resource C 8 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_components__ChatBlend_resource_c-8.png)
...
![20 Whatsapp Payment Components  ChatBlend Resource C 9 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_components__ChatBlend_resource_c-9.png)
...
- Once you have entered all the details, a new payment configuration will be made, which you can now go back to in  ChatBlend and configure the "Payment Configuration" section in.

![20 Whatsapp Payment Components  ChatBlend Resource C 10 Pn](/images/how-botpenguin-works/whatsapp-payment-comp/20.whatsapp_payment_components__ChatBlend_resource_c-10.png)

And, you are done\! You have successfully configured the Payments options on your WhatsApp bot.

### **FAQ's:**

Here are some common FAQ's regarding payment components in  ChatBlend:
