...
![18 Trigger Actions  ChatBlend Resource Centre 1 Pn](/images/how-botpenguin-works/trigger-action/18.trigger_actions__ChatBlend_resource_centre-1.png)
...
- Additional If-Else branches can be added using the **"Add If/Else Branch"** button.
  ...
  ![18 Trigger Actions ChatBlend Resource Centre 3 Pn](/images/how-botpenguin-works/trigger-action/18.trigger_actions__ChatBlend_resource_centre-2.png)
- The available "**Condition On**" options include:
  ...
  - Finally, users must **select the next message** to determine the chatflow's progression after a condition is met.
    ...
    ![18 Trigger Actions  ChatBlend Resource Centre 4 Pn](/images/how-botpenguin-works/trigger-action/18.trigger_actions__ChatBlend_resource_centre-3.png)
...
- Integrate your preferred LLM directly from here using the "AI Provider Integration Required" box
  ...
  ![18 Trigger Actions  ChatBlend Resource Centre 4 Pn](/images/how-botpenguin-works/trigger-action/18.trigger_actions__ChatBlend_resource_centre-4.png)
...
- You can choose not to assign tasks to offline agents and assign them only during business hours.
  ...
  ![18 Trigger Actions  ChatBlend Resource Centre 5 Pn](/images/how-botpenguin-works/trigger-action/18.trigger_actions__ChatBlend_resource_centre-5.png)