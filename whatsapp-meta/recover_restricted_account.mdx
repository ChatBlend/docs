...
2. Navigate to **All Tools**(represented as 3 horizontal lines)**\> Business Support Home**.
   ...
   ![231 Recovering Your Restricted Meta Account ChatBlend 1 Pn](/images/platform-guidelines-training/recovering-restricted-account/231.recovering_your_restricted_meta_account__ChatBlend-1.png)
...
4. Click on "**Account Overview**", sole icon of the left sidebar, to see all the related accounts.
   ...
   ![231 Recovering Your Restricted Meta Account  ChatBlend 2 Pn](/images/platform-guidelines-training/recovering-restricted-account/231.recovering_your_restricted_meta_account__ChatBlend-2.png)
5. The status of all the accounts will be shown. Click on the "**View Account**" to see the detailed summary of the issues.

   ![231 Recovering Your Restricted Meta Account  ChatBlend 3 Pn](/images/platform-guidelines-training/recovering-restricted-account/231.recovering_your_restricted_meta_account__ChatBlend-3.png)
...
7. Click on the "**Request Review**".
   ...
   ![231 Recovering Your Restricted Meta Account  ChatBlend 5 Pn](/images/platform-guidelines-training/recovering-restricted-account/231.recovering_your_restricted_meta_account__ChatBlend-4.png)
...
![231 Recovering Your Restricted Meta Account  ChatBlend 5 Pn](/images/platform-guidelines-training/recovering-restricted-account/231.recovering_your_restricted_meta_account__ChatBlend-5.png)
...
If you can having any questions, you can look into our repository of FAQs. Most likely, you will find your answer here. If not, write us at [support@ ChatBlend.com](mailto:support@ ChatBlend.com).