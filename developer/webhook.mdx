...
### **Benefits of Using Webhooks in  ChatBlend**

The following are the benefits of using webhooks on  ChatBlend:
...
### **How to use Webhooks on  ChatBlend:**

1. Log into your  ChatBlend account, and then go **Developer** section under the More section.
2. Click on the third tab to access the "Webhooks" section.

   ![189 Webhooks  ChatBlend Resource Centre 1 Pn](/images/how-botpenguin-works/webhook/189.webhooks__ChatBlend_resource_centre-1.png)
...
5. Click on "Subscribe Webhooks".
   ...
   ![189 Webhooks  ChatBlend Resource Centre 2 Pn](/images/how-botpenguin-works/webhook/189.webhooks__ChatBlend_resource_centre-2.png)
6. A small popup window will open up. Enter your Webhook Endpoint, and verification key. Then, select the bots that you want the webhooks to be triggered for.
   ...
   ![189 Webhooks  ChatBlend Resource Centre 3 Pn](/images/how-botpenguin-works/webhook/189.webhooks__ChatBlend_resource_centre-3.png)
...
![189 Webhooks  ChatBlend Resource Centre 4 Pn](/images/how-botpenguin-works/webhook/189.webhooks__ChatBlend_resource_centre-4.png)
...
![189 Webhooks  ChatBlend Resource Centre 6 Pn](/images/how-botpenguin-works/webhook/189.webhooks__ChatBlend_resource_centre-5.png)
...
3. To disconnect the webhook, turn off the status of the webhook. To disconnect all the webhooks status, click on the "Unsubscribe Webhooks" button and confirm the unhook process.
   ...
   ![189 Webhooks  ChatBlend Resource Centre 6 Pn](/images/how-botpenguin-works/webhook/189.webhooks__ChatBlend_resource_centre-6.png)

### **Account Level Webhooks**

![189 Webhooks  ChatBlend Resource Centre 7 Pn](/images/how-botpenguin-works/webhook/189.webhooks__ChatBlend_resource_centre-7.png)
...
<AccordionGroup>
  <Accordion title="What are webhooks in  ChatBlend?">
    Webhooks are automated callbacks that notify your system in real-time when specific events occur on  ChatBlend, such as message delivery failures or subscription changes.
  </Accordion>
  <Accordion title="Which platform do  ChatBlend webhooks support?">
    Webhooks are supported for WhatsApp, Instagram, and application-level events within the  ChatBlend ecosystem.
  </Accordion>
  ...
  <Accordion title="Are webhooks real time?">
    Yes.  ChatBlend webhooks are designed to send event notifications immediately as they occur.
  </Accordion>
  ...
  <Accordion title="How can I test if my webhook is working?">
     ChatBlend provides testing options within the webhook configuration section, allowing you to simulate event triggers and validate your endpoint setup.
  </Accordion>
  <Accordion title="What should I do if my webhook endpoint fails?">
    Ensure your endpoint URL is active and accessible.  ChatBlend may retry failed deliveries, but persistent failures will require you to debug and update your configuration.
  </Accordion>
</AccordionGroup>
