...
```
https://api.v7. ChatBlend.com/whatsapp-automation/wa/templates?apiKey=*API KEY*
```
...
```
curl --location --request GET 'https://api.v7. ChatBlend.com/whatsapp-automation/wa/templates?apiKey=*API KEY*' \\
