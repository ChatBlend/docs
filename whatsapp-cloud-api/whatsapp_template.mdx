...
```
https://api.v7. ChatBlend.com/whatsapp-automation/wa/send-template?apiKey=*API KEY*
```
...
```
curl --location --request POST '<https://api.v7. ChatBlend.com/whatsapp-automation/wa/send-template?apiKey=> *Shared Separately*' \\
