---
title: "AI Settings "
description: "This page contains the information on how you can use the  ChatBlend AI to enhance your chatbot capabilities."
---

### ChatBlend AI

ChatBlend utilizes a combination of ChatGPT, proprietary technology, and specialized training to create custom AI models tailored to your business's unique knowledge and customer service needs.

You can feed data to your custom AI model through various sources, including website URLs, content files, and FAQs. This enables  ChatBlend to develop AI solutions that deliver exceptional service and support to your customers by leveraging both publicly available information and your business-specific data.

### **Setup ChatGPT and AI Settings**

To integrate ChatGPT into your  ChatBlend chatbot and customize its behavior, follow these steps:
...
- Navigate to the "AI settings" section inside "Instagram Chatbot Settings".
  ...
  ![73 Ai Settings  ChatBlend Resource Centre 1 Pn](/images/how-botpenguin-works/instagram-ai-setting/73.ai_settings_\_ChatBlend_resource_centre-6.png)

Step 3:

- Click on "**Create a Persona**".

  ![73 Ai Settings  ChatBlend Resource Centre 1 Pn](/images/how-botpenguin-works/instagram-ai-setting/73.ai_settings_\_ChatBlend_resource_centre-7.png)
...
![73 Ai Settings  ChatBlend Resource Centre 2 Pn](/images/how-botpenguin-works/instagram-ai-setting/73.ai_settings_\_ChatBlend_resource_centre-1.png)

- In Persona Details enter the persona title, persona description and upload a cover photo for your bot's persona.

  ![73 Ai Settings  ChatBlend Resource Centre 6 Pn](/images/how-botpenguin-works/instagram-ai-setting/73.ai_settings_\_ChatBlend_resource_centre-8.png)
...
![73 Ai Settings  ChatBlend Resource Centre 2 Pn](/images/how-botpenguin-works/instagram-ai-setting/73.ai_settings_\_ChatBlend_resource_centre-2.png)
...
- You can also toggle ON/OFF to show live chat button when the scenerio is identified
  ...
  ![73 Ai Settings  ChatBlend Resource Centre 3 Pn](/images/how-botpenguin-works/instagram-ai-setting/73.ai_settings_\_ChatBlend_resource_centre-3.png)
...
![73 Ai Settings  ChatBlend Resource Centre 4 Pn](/images/how-botpenguin-works/instagram-ai-setting/73.ai_settings_\_ChatBlend_resource_centre-4.png)
...
![73 Ai Settings  ChatBlend Resource Centre 5 Pn](/images/how-botpenguin-works/instagram-ai-setting/73.ai_settings_\_ChatBlend_resource_centre-5.png)
