---
title: "Role"
description: "This page contains all the necessary information regarding the "Role" section of the ChatBlend platform."
---

### **What is the Roles Section?**

The **Roles** section allows administrators to create custom permission sets that define what team members can view, modify, or delete across different areas of the ChatBlend platform. This helps enforce access control, data security, and workflow governance within your organization.
...
- Click on the "Roles" panel to view and manage the roles you have created.
  ...
  ![184 Role  ChatBlend Resource Centre 1 Pn](/images/how-botpenguin-works/role/184.role__ChatBlend_resource_centre-1.png)
- Next, click on **"Create Role"** to start the process of creating a new role.

  ![184 Role  ChatBlend Resource Centre 2 Pn](/images/how-botpenguin-works/role/184.role__ChatBlend_resource_centre-2.png)
...
- **Assign Permissions:** You can select the sections you want to allow or block users from accessing in this role.
  ...
  ![184 Role  ChatBlend Resource Centre 3 Pn](/images/how-botpenguin-works/role/184.role__ChatBlend_resource_centre-3.png)
...
![184 Role  ChatBlend Resource Centre 4 Pn](/images/how-botpenguin-works/role/184.role__ChatBlend_resource_centre-4.png)
...
- **Action:** You can **edit** or **delete** any of the existing roles from here.
  ...
  ![184 Role  ChatBlend Resource Centre 5 Pn](/images/how-botpenguin-works/role/184.role__ChatBlend_resource_centre-5.png)
