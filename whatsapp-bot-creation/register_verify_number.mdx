...
2. Click on the "Add Product" option.
   ...
   ![223 Register Verify Your Whatsapp Number  ChatBlend 1 Pn](/images/platform-guidelines-training/register-verify-number/223.register__verify_your_whatsapp_number__ChatBlend_-1.png)
...
2. Click on the "Setup" button associated with the WhatsApp product.
   ...
   ![223 Register Verify Your Whatsapp Number  ChatBlend 2 Pn](/images/platform-guidelines-training/register-verify-number/223.register__verify_your_whatsapp_number__ChatBlend_-2.png)

#### **Step 4: Navigate to API Setup**

1. In the sidebar, find and click on the "API Setup" option under the "WhatsApp" section.

   ![223 Register Verify Your Whatsapp Number  ChatBlend 3 Pn](/images/platform-guidelines-training/register-verify-number/223.register__verify_your_whatsapp_number__ChatBlend_-3.png)
...
2. Click on the "Add phone number" button.
   ...
   ![223 Register Verify Your Whatsapp Number  ChatBlend 4 Pn](/images/platform-guidelines-training/register-verify-number/223.register__verify_your_whatsapp_number__ChatBlend_-4.png)
...
3. After providing the details, click on the "Next" button.
   ...
   ![223 Register Verify Your Whatsapp Number  ChatBlend 5 Pn](/images/platform-guidelines-training/register-verify-number/223.register__verify_your_whatsapp_number__ChatBlend_-5.png)
...
2. Request a verification code by clicking the appropriate button.
   ...
   ![223 Register Verify Your Whatsapp Number  ChatBlend 6 Pn](/images/platform-guidelines-training/register-verify-number/223.register__verify_your_whatsapp_number__ChatBlend_-6.png)
...
Please note that the process of adding and verifying the WhatsApp number may vary based on any updates or changes in the Meta Developer Dashboard. If you encounter any difficulties or issues during the process, please refer to the official Meta documentation or reach out to  ChatBlend support team for further assistance.