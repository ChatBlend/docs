...
![222 Create A Meta App  ChatBlend Resource Centre 1 Pn](/images/platform-guidelines-training/create-meta-app/222.create_a_meta_app__ChatBlend_resource_centre-1.png)

### **Step 3: Choose an app type**

Choose the app type as per your use case. In most cases it is `Business` .

![222 Create A Meta App  ChatBlend Resource Centre 2 Pn](/images/platform-guidelines-training/create-meta-app/222.create_a_meta_app__ChatBlend_resource_centre-2.png)
...
![222 Create A Meta App  ChatBlend Resource Centre 3 Pn](/images/platform-guidelines-training/create-meta-app/222.create_a_meta_app__ChatBlend_resource_centre-3.png)