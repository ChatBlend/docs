...
2. Click on "System Users" and click "Add" to add a new user
   ...
   ![226 Assign System User To Whatsapp Account  ChatBlend 1 Pn](/images/platform-guidelines-training/assign-system-user/226.assign_system_user_to_whatsapp_account__ChatBlend-1.png)
3. Accept the policy to start adding user

   ![226 Assign System User To Whatsapp Account  ChatBlend 2 Pn](/images/platform-guidelines-training/assign-system-user/226.assign_system_user_to_whatsapp_account__ChatBlend-2.png)
4. Once the "Create system user" pop-up opens, Give a name (E.g. BP-WhatsApp) and keep the user role as "Admin"

   ![226 Assign System User To Whatsapp Account  ChatBlend 3 Pn](/images/platform-guidelines-training/assign-system-user/226.assign_system_user_to_whatsapp_account__ChatBlend-3.png)
5. Once the system user is added, Click on the "Generate new token"

   ![226 Assign System User To Whatsapp Account  ChatBlend 4 Pn](/images/platform-guidelines-training/assign-system-user/226.assign_system_user_to_whatsapp_account__ChatBlend-4.png)
6. Once the "Generate Token" pop-up opens up,
   ...
   - Assign following permissions
     ...
     ![226 Assign System User To Whatsapp Account  ChatBlend 5 Pn](/images/platform-guidelines-training/assign-system-user/226.assign_system_user_to_whatsapp_account__ChatBlend-5.png)
...
2. Click on "WhatsApp Accounts."
   ...
   ![226 Assign System User To Whatsapp Account  ChatBlend 7 Pn](/images/platform-guidelines-training/assign-system-user/226.assign_system_user_to_whatsapp_account__ChatBlend-6.png)
...
2. A list of available system users will appear.
   ...
   ![226 Assign System User To Whatsapp Account  ChatBlend 7 Pn](/images/platform-guidelines-training/assign-system-user/226.assign_system_user_to_whatsapp_account__ChatBlend-7.png)
...
2. Assign "Full control" permissions to the selected system user over the WhatsApp Business Account.
   ...
   ![226 Assign System User To Whatsapp Account  ChatBlend 8 Pn](/images/platform-guidelines-training/assign-system-user/226.assign_system_user_to_whatsapp_account__ChatBlend-8.png)
