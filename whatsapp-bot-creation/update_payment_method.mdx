...
2. Click on the "API Setup" option under the "WhatsApp" section.
   ...
   ![225 Update Wa Account Payment Method  ChatBlend Resou 1 Pn](/images/platform-guidelines-training/update-wa-account/225.update_wa_account_payment_method__ChatBlend_resou-1.png)
...
2. Click on the "Add payment method" button.
   ...
   ![225 Update Wa Account Payment Method  ChatBlend Resou 2 Pn](/images/platform-guidelines-training/update-wa-account/225.update_wa_account_payment_method__ChatBlend_resou-2.png)
...
2. In the "Meta Business Manager," locate and click on the "Payment Setting" button.
   ...
   ![225 Update Wa Account Payment Method  ChatBlend Resou 3 Pn](/images/platform-guidelines-training/update-wa-account/225.update_wa_account_payment_method__ChatBlend_resou-3.png)
...
1. On the "Billing and Payments" page, click on the "Add Payment Method" option to add a new payment method.
   ...
   ![225 Update Wa Account Payment Method  ChatBlend Resou 4 Pn](/images/platform-guidelines-training/update-wa-account/225.update_wa_account_payment_method__ChatBlend_resou-4.png)

#### **Step 6: Select Payment Method Type**

1. Choose the payment method type that you want to use for your WhatsApp account.

   ![225 Update Wa Account Payment Method  ChatBlend Resou 5 Pn](/images/platform-guidelines-training/update-wa-account/225.update_wa_account_payment_method__ChatBlend_resou-5.png)

#### **Step 7: Enter Payment Details**

1. Enter the necessary payment details based on the selected payment method.

   ![225 Update Wa Account Payment Method  ChatBlend Resou 6 Pn](/images/platform-guidelines-training/update-wa-account/225.update_wa_account_payment_method__ChatBlend_resou-6.png)
...
Please ensure to keep your payment details secure and up-to-date. If you encounter any difficulties during the process or have further questions regarding payment methods on WhatsApp, please refer to the official Meta documentation or contact  ChatBlend support team for assistance.