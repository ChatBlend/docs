...
To use the  ChatBlend APIs, You need to insure that you have following details with you.

A. **UUID** - You can get the UUID from the local web session storage as show in the image below:

![251 Website Contacts Meta Data  ChatBlend Resource C 1 Pn](/images/api-references/website-contact-metadata/251.website_contacts__meta_data__ChatBlend_resource_c-1.png)
...
https://page. ChatBlend.com/BotId/CustomerId
...
<script id=" ChatBlend-messenger-widget" src="https://cdn. ChatBlend.com/ ChatBlend.js" defer>BotId,CustomerId</script>
...
### **Create a lead in the  ChatBlend**
...
`PUT` `https://api.v7. ChatBlend.com/inbox/direct/lead`
...
`GET` `https://api.v7. ChatBlend.com/inbox/direct/chats`
    ...
    "data": [
        {
            ...
            "lastMessage": {
                ...
                "by": "bot",
                "text": "Welcome to  ChatBlend. I am here to help you."
            },
...
If you have any questions, you can look into our repository of FAQs, most likely, you will find your answer here, If not, write us at [support@ ChatBlend.com](mailto:support@ ChatBlend.com).