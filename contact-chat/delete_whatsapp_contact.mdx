...
This API endpoint allows you to update the status of users in your  ChatBlend application.

**Endpoint URL:** `https://api.v7. ChatBlend.com/inbox/users/status-update`
...
```
curl 'https://api.v7. ChatBlend.com/inbox/users/status-update' \
  -X 'PUT' \
