...
The **Inbox User Import API** allows you to import WhatsApp contacts into the  ChatBlend platform. You can use this API to create or update WhatsApp contacts with various attributes and contact information.

#### **Base URL**

```
https://api.v7. ChatBlend.com/inbox/users/import
```
...
```
curl 'https://api.v7. ChatBlend.com/inbox/users/import' \
  -H 'Authorization: Bearer eyJhbGciOiJSUzUxMiIsInR5cCI6IkpXVCJ9...' \
  -H 'Content-Type: application/json' \
  -H 'Accept: */*' \
  -H 'Origin: https://app. ChatBlend.com' \
  -H 'Referer: https://app. ChatBlend.com/' \
...
The Inbox User Import API allows you to easily import user profiles into the  ChatBlend platform. Make sure to follow the authentication and data format guidelines for successful imports.
