---
title: "Integrate  ChatBlend with Google Analytics"
description: "This page contains step by step information on how you can integrate the Google Analytics with the  ChatBlend."
---

#### **Integration of Google Analytics with  ChatBlend**

Google Analytics is a powerful tool to measure and analyze user interactions, such as the number of clicks and views, on your chatbot. Integrating Google Analytics with your  ChatBlend chatbot enables you to track these metrics and optimize performance.

Follow these steps to integrate Google Analytics with  ChatBlend:

**Step 1: Log in to  ChatBlend**

1. Navigate to your [ ChatBlend account](https://www. ChatBlend.com/).
...
To connect Google Analytics to your  ChatBlend account, you need the Measurement ID from your Google Analytics account. Follow these steps to get it:
...
**Step 4: Connect Google Analytics to  ChatBlend**

1. Go back to the  ChatBlend integration page where you clicked **Connect** for Google Analytics.
