---
title: "Integrate  ChatBlend with NetHunt CRM"
...
to complete integration of  ChatBlend with NetHunt.
...
a. Now, as connection of the  ChatBlend and NetHunt CRM is established, you need

to map **parameters (fields) of NetHunt CRM** to the user response of the  ChatBlend question.
...
As a result, this mapping will enable integration to send the user's response from
 ...
 ChatBlend to the NetHunt CRM’s **Name **field in the leads. Similarly, in order for integration to work properly, you will require to map all other questions/ components of your Bot to NetHunt CRM fields.
...
Once you have established a connection between ** ChatBlend** and **NetHunt CRM**, and the mapping is complete, you are ready to go for your first test lead. You can test your integration setup by creating a dummy lead on the bot. This lead should appear in your  ChatBlend dashboard as well as in the NetHunt CRM that you have integrated.
