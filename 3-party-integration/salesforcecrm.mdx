---
title: "Integrate  ChatBlend with Salesforce CRM"
...
1. Login to your  ChatBlend account. Now, select and click the Bot you want to
...
1. Enter the Salesforce Domain, Client ID and Client Secret and click the ‘Connect’ button to complete integration of  ChatBlend with Salesforce.
...
1. Now, as the connection of the  ChatBlend and Salesforce CRM is established, you need to map **parameters(fields) of Salesforce CRM** to the user response to the  ChatBlend question.
...
As a result, this mapping will enable integration to send the user's response from  ChatBlend to the Salesforce CRM’s **Name **field in the leads. Similarly, in order for integration to work properly, you will require to map all other questions/ components of your Bot to Salesforce CRM fields.
