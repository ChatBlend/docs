...
### **Steps of Integration with  ChatBlend:**
 ...
 3. \
    If a pop-up screen appears, go to the bottom and click on "**Shopify App Store"**. Search for "** ChatBlend**" and click on "**Install**".
 ...
 5. \
    Once the installation process is complete, the page will automatically redirect you to  ChatBlend, while a screen such as this appears.
 6. \
    You will be redirected to  ChatBlend. Login to your account.
 7. \
...
11. \
    You will be redirected to Shopify admin panel, which will redirect back to the  ChatBlend page, and this will confirm your integration.
