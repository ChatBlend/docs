---
title: "Integrate  ChatBlend with Shopify"
description: "This page offers a step by step guide into connecting  ChatBlend with Shopify"
---
...
### **Benefits of Integrating Shopify with  ChatBlend:**

Combining Shopify through  ChatBlend allows you to:
...
### **Steps of Integration with  ChatBlend:**

 1. Log-in to your shopify account and go to the admin panel.
 2. Click on the "**Add apps**".
 3. If a pop-up screen appears, go to the bottom and click on "**Shopify App Store"**. Search for "** ChatBlend**" and click on "**Install**".

    <Info>
      If you are currently logged into  ChatBlend in another tab, be sure to log out first from there before proceeding to the next steps.
    </Info>
 ...
 5. Once the installation process is complete, the page will automatically redirect you to  ChatBlend, while a screen such as this appears.
 6. You will be redirected to  ChatBlend. Login to your account.
...
11. You will be redirected to Shopify admin panel, which will redirect back to the  ChatBlend page, and this will confirm your integration.
...
Here are some common FAQ's identified with Shopify integration with  ChatBlend:

<AccordionGroup>
  <Accordion title="Can I use this integration if I have multiple Shopify stores?">
    Yes, but each Shopify store should be connected to a separate bot on  ChatBlend. One bot = one store.
  </Accordion>
  ...
  <Accordion title="My bot is not connecting with Shopify. What to do?">
    If facing trouble connecting with  ChatBlend, please check the following:
    ...
    4. Make sure your WhatsApp bot is already live/published on  ChatBlend. Draft or incomplete bots may cause issues.
  </Accordion>
</AccordionGroup>
