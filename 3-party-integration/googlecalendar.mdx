---
title: "Integrate  ChatBlend with Google Calendar"
description: "This is a step by step guide to showcase the integration of Google Calendar with  ChatBlend"
---

### **Why use Google Calendar?**

ChatBlend integrates with Google Calendar to automate scheduling, reminders, and event management. By syncing  ChatBlend’s AI-driven chatbot with Google Calendar, businesses can automatically schedule meetings, send reminders, and manage calendar events through chatbot interactions. This integration helps streamline the scheduling process, ensures timely reminders, and enhances overall productivity by reducing manual calendar management.
...
- **Seamless Event Management:** Easily create, reschedule, or cancel events with the help of  ChatBlend, directly syncing with Google Calendar.
...
#### **Why Integrate Google Calendar with  ChatBlend?**
...
### **Steps to Integrate Google Calendar with  ChatBlend**

 1. Login to your  ChatBlend account. Now, select and click the chatbot you want to integrate with Google Calendar. Click on the “**Third-party Apps Integration”.**
...
A lot of questions might arise when integrating  ChatBlend with Google Calendar. Some of the most popular questions are answered below:
...
<AccordionGroup>
  ...
  <Accordion title="Can I integrate with a shared or a team calendar instead of a personal calendar">
    At present,  ChatBlend only supports integration with the primary calendar associated with the connected Google account. Shared or team calendars are not natively supported unless added to the same Google account and made the default.
  </Accordion>
  ...
  <Accordion title="How do I properly configure the chatbot with gogle calendar?">
    ...
    1. **Integrate the bot with Google Calendar** via the Third-Party Integrations section in your  ChatBlend dashboard.
