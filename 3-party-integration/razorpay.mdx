---
title: "Integrate  ChatBlend with Razorpay"
description: "This page contains al the necessary information on how you can interate the Razorpay with Botepenguin"
---

### **Prerequisites**

To successfully integrate Razorpay with  ChatBlend, you will need:

- A ** ChatBlend** account.
- A **Razorpay** account.
- A **WhatsApp bot**

This integration enables your WhatsApp bot created on  ChatBlend to collect payments via Razorpay.

#### **Step 1: Login to  ChatBlend and Select WhatsApp Bot**

1. Go to [ ChatBlend](https://www. ChatBlend.com/) and log into your account.
...
To connect Razorpay with  ChatBlend, you need the **Client ID** and **Client Secret** from your Razorpay account.
...
#### **Step 4: Connect Razorpay to  ChatBlend**
...
4. Go back to  ChatBlend and copy the **Webhook URL** from the integration settings.
...
1. Navigate back to your  ChatBlend bot editor.
2. \
...
Your  ChatBlend WhatsApp bot is now successfully integrated with Razorpay. You can collect payments seamlessly and track payment events through the configured webhooks. This integration ensures a smooth payment experience for your users directly through WhatsApp.   