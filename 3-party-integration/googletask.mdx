---
title: "Integrate  ChatBlend with Google Task"
description: "This page contains the stepwise tutorial for the integration with  ChatBlend"
---

### **Why use Google Tasks?**

ChatBlend integrates with Google Tasks to help users automate task management and improve productivity. By combining  ChatBlend’s conversational AI with Google Tasks’ simple task management features, businesses can create, update, and assign tasks directly from chatbot interactions. This integration enables seamless task tracking and ensures that all tasks are organized and synchronized across devices, improving team collaboration and personal productivity.
...
a. Login to your  ChatBlend account. Now, select and click the Bot you want to integrate

with Google Task. Click on the ‘Integrate tab.’

b. The Integrate Window Will Open up. Select the ‘All Integrations’ Tab.

c. A list of all native integrations for  ChatBlend will be available in this window.
...
b. Now, click allow for  ChatBlend to access your Google account.

c. After you click allow, the connection between  ChatBlend and Google Task is

established,and you will be redirected back to  ChatBlend.

### **Step 3 of 4: Set up Mapping Parameters**

a. Now, as connection of the  ChatBlend and Google Task is established, you need

to map **parameters (fields) of Google Task** to the user response of the  ChatBlend question.
...
ChatBlend to the Google Task’s Name field in the leads. Similarly, in order for integration to work properly, you will require to map all other questions/ components of your Bot to Google Task fields.
...
Once you have established a connection between ChatBlend and **Google Task**, and the mapping is complete, you are ready to go for your first test lead. You can test your integration setup by creating a dummy lead on the bot. This lead should appear in your  ChatBlend dashboard as well as in the Google Task you have integrated.
