---
title: "Integrate  ChatBlend with SimplyBook"
description: "This page contains the stepwise tutorial for the integration of SimplyBook with  ChatBlend."
---

**\
Access Your  ChatBlend Account**

- Log in to your  ChatBlend account and select the bot you wish to integrate with SimplyBook.

**\
Navigate to Third-Party App Integrations**

- Go to the "Third-Party App Integrations" section in your  ChatBlend account.
