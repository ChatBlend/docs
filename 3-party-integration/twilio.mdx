...
#### **Step 2: Getting the Information from Twilio.**
 ...
 5. \
    Copy and paste the same tokens in the  ChatBlend Applciation.
...
14. \
    Copy the same in your  ChatBlend Account.
15. \
...
17. \
    Make sure both the "Voice Configuration", and scrolling down, the Messaging Configuration have the URL as copied from  ChatBlend.
18. \
