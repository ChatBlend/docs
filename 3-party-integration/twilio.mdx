---
title: "Integrate  ChatBlend with Twilio"
description: "This page provides a step-by-step guide on integration of  ChatBlend with Twilio"
---

### **Why use Twilio?**

Integrate Twilio with your  ChatBlend chatbot to enable seamless SMS and WhatsApp messaging. This allows your chatbot to reach users directly on their phones, improving engagement, outreach, and customer satisfaction. Whether you're sending order updates or automating lead follow-ups, Twilio ensures reliable delivery.
...
- Your  ChatBlend chatbot is published and assigned to a valid channel.

---

### **Steps to Integrate  ChatBlend with Twilio:**

#### **Step 1: Going to Integration on  ChatBlend**

1. Sign into your  ChatBlend account and choose the chatbot. Go to "Third Party Apps Integrations"
...
#### **Step 2: Getting the Information from Twilio.**
 ...
 5. Copy and paste the same tokens in the  ChatBlend Applciation.
 ...
 7. Fill the Name and Request URL which is under "Voice Configuration".
    - Set the name as " ChatBlend".
    - Copy the code in  ChatBlend Twilio Integration Screen, and paste it in the Request URL box.
 8. This will create a new application.
 9. Click on the application to see the **TwiLM App SID**. Copy the ID over to the  ChatBlend platform.
...
14. Copy the same in your  ChatBlend Account.
...
17. Make sure both the "Voice Configuration", and scrolling down, the Messaging Configuration have the URL as copied from  ChatBlend.
...
<AccordionGroup>
  <Accordion title="Does  ChatBlend offer SMS services with Twilio">
    No,  ChatBlend only offers Twilio with Voice calling configuration.
  </Accordion>
