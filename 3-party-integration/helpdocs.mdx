...
- **Real-Time Knowledge Updates:** Ensure the chatbot delivers up-to-date information by syncing  ChatBlend with the latest HelpDocs content.

---

### **Integrate  ChatBlend with Helpdocs:-**

### **Step 1 of 5: Login to  ChatBlend Account and Select Application to Integrate**

1. Login to your  ChatBlend account, and select the Bot you want to integrate with HelpDocs.
...
8. Moreover, copy your API Key from here to paste it into your  ChatBlend Account.
9. \
...
1. Now, as the connection of the  ChatBlend and **HelpDocs** is established, you need to map the **parameters (fields) of HelpDocs **to the user response of the  ChatBlend question.
2. \
...
Once you have established a connection between ** ChatBlend** and **HelpDocs** and complete the mapping, you are ready to go for your first test lead. You can test your integration setup by creating a dummy lead on the bot. This lead should appear in your  ChatBlend dashboard and in the HelpDocs you have integrated.
...
- Wrong Mapping Set up - Your mapping with  ChatBlend Question and HelpDocs parameter is either incorrect or you haven’t added any mandatory parameter.
