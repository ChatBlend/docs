---
title: "Integrate  ChatBlend with Zendesk CRM"
description: "This page contains the stepwise tutorial for the integration with  ChatBlend"
---

### **Why use Zendesk CRM?**

ChatBlend integrates with Zendesk to enhance customer support and improve ticket management. By combining  ChatBlend’s AI-driven chatbot with Zendesk’s customer service and helpdesk platform, businesses can automatically respond to customer queries, create and assign tickets, and track customer interactions in real-time. This integration helps streamline workflows, reduce response times, and ensure customer issues are resolved efficiently.
...
- **24/7 Availability:** Offer continuous support through  ChatBlend, ensuring customers get assistance at any time, day or night.

---

### **Step 1 of 5: Login to  ChatBlend Account and Select Application to Integrate**
...
click the ‘Connect’ Button to complete integration of  ChatBlend with Zendesk.
...
a. Now, as connection of the  ChatBlend and Zendesk is established, you need

to map **parameters (fields) of Zendesk** to the user response of the  ChatBlend question.
...
ChatBlend to the Zendesk’s Name field in the leads. Similarly, in order for integration to work properly, you will require to map all other questions/ components of your Bot to Zendesk fields.
...
Once you have established a connection between ChatBlend and **Zendesk**, and the mapping is complete, you are ready to go for your first test lead. You can test your integration setup by creating a dummy lead on the bot. This lead should appear in your  ChatBlend dashboard as well as in the Zendesk you have integrated.
