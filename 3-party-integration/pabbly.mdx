...
3. \
   Upon clicking “**Create**”, automatic redirection should occur to the workflow as shown below. For creation of trigger from  ChatBlend, search “** ChatBlend**” in the “**Search App**”.
4. \
   After searching and selecting  ChatBlend, select the same type of “**Trigger Event**” you want from the dropdown menu as in  ChatBlend. These can include:
   - **New Lead**: Trigger which occurs whenever a new contact is created in  ChatBlend.
   - **New Incoming Messages**: Occurs when a new message is incoming in the selected chatflow being integrated.
   - **New WhatsApp Order Created**: When a new order is placed.
5. \
   Upon selection, the box will expand as seen below, including in itself several more details. Copy the “**Webhook URL**” and paste it in the “**Pabbly Webhook URL**” in  ChatBlend Dashboard.
6. \
   Paste the copied Webhook URL in the “**Pabbly Webhook URL**” on  ChatBlend, and then click “**Verify & Add Webhook URL**”.
...
4. \
   Search for “** ChatBlend**” in the “**Search App**” area, and select the same.
...
8. \
   Post successful save, information will be need to be entered or mapped that will be sent to  ChatBlend. Edit the same in the given columns.
9. \
