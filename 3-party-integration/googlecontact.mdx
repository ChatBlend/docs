---
title: "Integrate  ChatBlend with Google Contacts"
description: "This page includes all the necessary information on how you can integrate the Google contacts with  ChatBlend in details"
---

### **Use of Google Contacts?**

 ChatBlend integrates with Google Contacts to streamline contact management and improve customer interaction. By syncing  ChatBlend’s AI-powered chatbot with Google Contacts, businesses can automatically capture, update, and manage contact information in real-time. This integration allows for seamless data syncing, ensuring that customer profiles are always up-to-date and improving communication and follow-up processes.
...
### **Integrate  ChatBlend with Google Contacts**

 1. **Login to  ChatBlend:**
    - Start by logging into your  ChatBlend account.
 2. **\
    Navigate to the Bot:**
 ...
 6. **Login to Google Account:**
    - You will be prompted to log into your Google account. Ensure you use the Google account you want to link with  ChatBlend.
 7. **\
    Grant Permissions:**
    - Follow the on-screen instructions to grant  ChatBlend the necessary permissions to access your Google Contacts.
 8. **Map the Questions:**
...
11. **Check the Contact Section:**
    - In the "Contact" section of your  ChatBlend dashboard, you will see the demo leads created by the integration.
