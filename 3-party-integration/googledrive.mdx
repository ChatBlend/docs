---
title: "Integrate  ChatBlend with Google Drive"
description: "This page contains all the step by step information of how you can integrate the Google Drive with  ChatBlend."
---

### **Introduction**

Integrating Google Drive with  ChatBlend allows you to utilize external resources for training your AI chatbot.

### **Step-by-Step Integration Process**

#### **1. Login to  ChatBlend**

- Navigate to home page  to log in to your  ChatBlend account.
...
- Review the permissions requested by  ChatBlend.
...
- Contact  ChatBlend support if you encounter any issues.
