...
2. \
   As a result, this mapping will enable the integration to **send the user's response from  ChatBlend to GoHighLevel's CRM fields**, storing it correctly in the contact records.
