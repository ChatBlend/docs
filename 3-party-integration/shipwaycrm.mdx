---
title: "Integrate  ChatBlend with Shipway CRM"
...
integration of  ChatBlend with Shipway.
...
a. Now, as connection of the  ChatBlend and Shipway is established, you need

to map **parameters (fields) of Shipway** to the user response of the  ChatBlend question.
...
As a result, this mapping will enable integration to send the user's response from
 ...
 ChatBlend to the Shipway’s **Name **field in the leads. Similarly, in order for integration to work properly, you will require to map all other questions/ components of your Bot to Shipway fields.
...
Once you have established a connection between ** ChatBlend** and **Shipway**, and the mapping is complete, you are ready to go for your first test lead. You can test your integration setup by creating a dummy lead on the bot. This lead should appear in your  ChatBlend dashboard as well as in the Shipway you have integrated.
