...
### **How to use  ChatBlend as Trigger**
 ...
 8. \
    You can now click on the "\+" icon in canvas and search for  ChatBlend in the search bar.
...
### **How to use Action in  ChatBlend**
 ...
 8. \
    Set up connection by providing the **API key and BotID **from  ChatBlend as explained above.
