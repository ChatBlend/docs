...
<AccordionGroup>
  ...
  <Accordion title="How can I call customers using the call feature in the Leads section?">
    ChatBlend offers an integration with Twilio to call your leads directly from the Inbox on your desktop. You must integrate Twilio with ChatBlend to set up this calling feature.
  </Accordion>
  ...
  <Accordion title="How to integrate Twilio?">
    ...
    If you need further assistance, contact us at [support@ChatBlend.com](mailto:support@ChatBlend.com).
  </Accordion>
