...
<AccordionGroup>
  ...
  <Accordion title="How to disable desktop notifications">
    After you log in to the  ChatBlend App, Navigate to the `Bot Setting` under the bot's menu.  1. Go to the Bot Settings and open `Alerts` the tab.

    2. Check if you have subscribed to the desktop notifications or not?
    3. If yes, You will see the below confirmation.

    <img
      src="/images/how-botpenguin-works/bot-setting-faq/209.bot_settings_faqs__ChatBlend_resource_centre-1.png"
      alt="209 Bot Settings Faqs  ChatBlend Resource Centre 1 Pn"
      title="209 Bot Settings Faqs  ChatBlend Resource Centre 1 Pn"
      style={{ width:"74%" }}
    />
    ...
    **Disable Notifications**
    ...
    <img
      src="/images/how-botpenguin-works/bot-setting-faq/209.bot_settings_faqs__ChatBlend_resource_centre-2.png"
      alt="209 Bot Settings Faqs  ChatBlend Resource Centre 2 Pn"
      title="209 Bot Settings Faqs  ChatBlend Resource Centre 2 Pn"
      style={{ width:"54%" }}
    />
    ...
    <img
      src="/images/how-botpenguin-works/bot-setting-faq/209.bot_settings_faqs__ChatBlend_resource_centre-3.png"
      alt="209 Bot Settings Faqs  ChatBlend Resource Centre 3 Pn"
      title="209 Bot Settings Faqs  ChatBlend Resource Centre 3 Pn"
      style={{ width:"39%" }}
    />
