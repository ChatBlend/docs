...
<AccordionGroup>
  ...
  <Accordion title="How to add a new WhatsApp template?">
    You can create templates either from the WhatsApp Meta Manager or using the  ChatBlend template tab.
  </Accordion>
  ...
  <Accordion title="Is there any message limit?">
    No, all charges are conversations based.  ChatBlend’s platform pricing is based on the plan of conversations you choose.
  </Accordion>
