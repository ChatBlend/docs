...
<AccordionGroup>
  <Accordion title="How to install website bot using javascript">
    Copy the Javascript code from the  ChatBlend app & Go to
    ...
    **Please Note**
    ...
    2. Make sure  ChatBlend should be the last script to execute, as some scripts may override the  ChatBlend script.
  </Accordion>
  <Accordion title="How to install a bot on wordpress website">
    After you have logged into your  ChatBlend account, Go to the Bots Tab, select the desired Bot, and navigate to the Install section.
    ...
    3. Go to Plugins \> Add new \> Search  ChatBlend \> Install now \> Activate plugin"
    4. Install the " ChatBlend" Plugin and then activate the same.
    5. Upon activating the Plugin, you will be redirected to the plugins page with the confirmation message "Plugin Activated."
    6. Once your Plugin is activated, paste the Bot Penguin API key in the Box named " ChatBlend Snippet" that you Copied from your  ChatBlend account.
    7. Save the Settings, and you are all set.  ChatBlend has been integrated into your website.
  </Accordion>
  <Accordion title="Bot is not showing up upon activation of wp-rocket plugin">
    If you have both wp-rocket and  ChatBlend Plugin/Script added to your WordPress site, You may face the issue of the  ChatBlend not showing up on the website.
    ...
    3. Add the ` ChatBlend` bot script here under `Exclude Java Script Files` option, and done\!
  ...
  <Accordion title="What is the minimum browser version requirement for the  ChatBlend website bot">
     ChatBlend is a JS-based software. Hence your browser must support the Java Script. The minimum requirement for some renowned browsers are as follows:
  ...
  <Accordion title="How to resolve latency issues on my website when I have the chatbot installed">
    ...
    <script>
        ...
        scriptEle.src = ('src', 'https://cdn. ChatBlend.com/ ChatBlend.js');
        scriptEle.setAttribute('id', ' ChatBlend-messenger-widget');
    ...
    <img
      src="/images/how-botpenguin-works/bot-installation-faq/204.bot_installation_faqs__ChatBlend_resource_centre-1.png"
      alt="204 Bot Installation Faqs  ChatBlend Resource Centre 1 Pn"
      title="204 Bot Installation Faqs  ChatBlend Resource Centre 1 Pn"
      style={{ width:"77%" }}
    />
