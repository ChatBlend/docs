...
<AccordionGroup>
  ...
  <Accordion title="The email field is not accepting my email">
    ...
    1. You already have an account registered with this email on Convertalk.
  ...
  <Accordion title="I'm unable to add more than three team members">
    There is a limit of 3 team members on the standard plan. If you need to add more, contact us at [support@convertalk.com](mailto:support@convertalk.com) to discuss options.
  </Accordion>
  ...
  <Accordion title="My payment link has expired">
    ...
    2. If money was deducted but the transaction failed, it typically returns within three business days. If not, contact us at [support@convertalk.com](mailto:support@convertalk.com).
  </Accordion>
