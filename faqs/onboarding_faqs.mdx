...
description: "This section deals with key FAQs regarding user onboarding to the  ChatBlend"
---

<AccordionGroup>
  <Accordion title="I haven't recieved my verification link">
    If you haven't received your verification link, then you can check following things:   Check your spam folder in your Inbox.  You can also regenerate a new link after 30 seconds by clicking on the Resend button on the verification page.   If the issue persists, you can contact at [support@ ChatBlend.com](mailto:support@ ChatBlend.com) for further assistance.
  </Accordion>
  <Accordion title="I'm unable to send my verification link">
    ...
    If the issue persists, you can contact at [support@ ChatBlend.com](mailto:support@ ChatBlend.com) for further assistance.
  </Accordion>
  ...
  <Accordion title="How to upload a custom chatbot icon and color">
    1. [Login to the  ChatBlend] app using your registered credentials.
  ...
  <Accordion title="What is a facebook bot, and how does it help">
    Facebook Bot is the Integration of your Facebook business page and  ChatBlend Application. Once the Integration is completed and active,  ChatBlend enables you to run a pre-programmed flow on the Facebook page messenger.

    Automated messages are sent to people commenting on your page post and collect leads and many more features. To make the Integration, You will require to provide permissions to  ChatBlend to access your pages and manage certain permission.
  </Accordion>
  <Accordion title="How to get the whatsapp business API key">
    The WhatsApp Business API key is the access key to access your WhatsApp business API account. It enables you to access the messages/chat sent on your WhatsApp number, manage your WhatsApp profile, or many more features using the  ChatBlend platform. This key will be available once your mobile no has been whitelisted/approved for the Whatsapp Business API account by Meta.
  </Accordion>
  <Accordion title="What is telegram bot token">
    A Telegram bot token is an authentication token/key issued by Telegram. It enables you to access the messages/chat sent on your telegram bot, manage your Telegram contacts, or many more features using the  ChatBlend platform.
  </Accordion>
